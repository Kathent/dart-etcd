...
class KVApi {
  ...
  Future<RangeResponse> range(ClientContext ctx, RangeRequest request) {
    var emptyResponse = new RangeResponse();
    return _client.invoke(ctx, 'KV', 'Range', request, emptyResponse);
  }
  Future<PutResponse> put(ClientContext ctx, PutRequest request) {
    var emptyResponse = new PutResponse();
    return _client.invoke(ctx, 'KV', 'Put', request, emptyResponse);
  }
  Future<DeleteRangeResponse> deleteRange(ClientContext ctx, DeleteRangeRequest request) {
    var emptyResponse = new DeleteRangeResponse();
    return _client.invoke(ctx, 'KV', 'DeleteRange', request, emptyResponse);
  }
  Future<TxnResponse> txn(ClientContext ctx, TxnRequest request) {
    var emptyResponse = new TxnResponse();
    return _client.invoke(ctx, 'KV', 'Txn', request, emptyResponse);
  }
  Future<CompactionResponse> compact(ClientContext ctx, CompactionRequest request) {
    var emptyResponse = new CompactionResponse();
    return _client.invoke(ctx, 'KV', 'Compact', request, emptyResponse);
  }
}
...
class WatchApi {
  ...
  Future<WatchResponse> watch(ClientContext ctx, WatchRequest request) {
    var emptyResponse = new WatchResponse();
    return _client.invoke(ctx, 'Watch', 'Watch', request, emptyResponse);
  }
}
...
class LeaseApi {
  ...
  Future<LeaseGrantResponse> leaseGrant(ClientContext ctx, LeaseGrantRequest request) {
    var emptyResponse = new LeaseGrantResponse();
    return _client.invoke(ctx, 'Lease', 'LeaseGrant', request, emptyResponse);
  }
  Future<LeaseRevokeResponse> leaseRevoke(ClientContext ctx, LeaseRevokeRequest request) {
    var emptyResponse = new LeaseRevokeResponse();
    return _client.invoke(ctx, 'Lease', 'LeaseRevoke', request, emptyResponse);
  }
  Future<LeaseKeepAliveResponse> leaseKeepAlive(ClientContext ctx, LeaseKeepAliveRequest request) {
    var emptyResponse = new LeaseKeepAliveResponse();
    return _client.invoke(ctx, 'Lease', 'LeaseKeepAlive', request, emptyResponse);
  }
  Future<LeaseTimeToLiveResponse> leaseTimeToLive(ClientContext ctx, LeaseTimeToLiveRequest request) {
    var emptyResponse = new LeaseTimeToLiveResponse();
    return _client.invoke(ctx, 'Lease', 'LeaseTimeToLive', request, emptyResponse);
  }
}
...
class ClusterApi {
  ...
  Future<MemberAddResponse> memberAdd(ClientContext ctx, MemberAddRequest request) {
    var emptyResponse = new MemberAddResponse();
    return _client.invoke(ctx, 'Cluster', 'MemberAdd', request, emptyResponse);
  }
  Future<MemberRemoveResponse> memberRemove(ClientContext ctx, MemberRemoveRequest request) {
    var emptyResponse = new MemberRemoveResponse();
    return _client.invoke(ctx, 'Cluster', 'MemberRemove', request, emptyResponse);
  }
  Future<MemberUpdateResponse> memberUpdate(ClientContext ctx, MemberUpdateRequest request) {
    var emptyResponse = new MemberUpdateResponse();
    return _client.invoke(ctx, 'Cluster', 'MemberUpdate', request, emptyResponse);
  }
  Future<MemberListResponse> memberList(ClientContext ctx, MemberListRequest request) {
    var emptyResponse = new MemberListResponse();
    return _client.invoke(ctx, 'Cluster', 'MemberList', request, emptyResponse);
  }
}
...
class MaintenanceApi {
  ...
  Future<AlarmResponse> alarm(ClientContext ctx, AlarmRequest request) {
    var emptyResponse = new AlarmResponse();
    return _client.invoke(ctx, 'Maintenance', 'Alarm', request, emptyResponse);
  }
  Future<StatusResponse> status(ClientContext ctx, StatusRequest request) {
    var emptyResponse = new StatusResponse();
    return _client.invoke(ctx, 'Maintenance', 'Status', request, emptyResponse);
  }
  Future<DefragmentResponse> defragment(ClientContext ctx, DefragmentRequest request) {
    var emptyResponse = new DefragmentResponse();
    return _client.invoke(ctx, 'Maintenance', 'Defragment', request, emptyResponse);
  }
  Future<HashResponse> hash(ClientContext ctx, HashRequest request) {
    var emptyResponse = new HashResponse();
    return _client.invoke(ctx, 'Maintenance', 'Hash', request, emptyResponse);
  }
  Future<SnapshotResponse> snapshot(ClientContext ctx, SnapshotRequest request) {
    var emptyResponse = new SnapshotResponse();
    return _client.invoke(ctx, 'Maintenance', 'Snapshot', request, emptyResponse);
  }
}
...
class AuthApi {
  ...
  Future<AuthEnableResponse> authEnable(ClientContext ctx, AuthEnableRequest request) {
    var emptyResponse = new AuthEnableResponse();
    return _client.invoke(ctx, 'Auth', 'AuthEnable', request, emptyResponse);
  }
  Future<AuthDisableResponse> authDisable(ClientContext ctx, AuthDisableRequest request) {
    var emptyResponse = new AuthDisableResponse();
    return _client.invoke(ctx, 'Auth', 'AuthDisable', request, emptyResponse);
  }
  Future<AuthenticateResponse> authenticate(ClientContext ctx, AuthenticateRequest request) {
    var emptyResponse = new AuthenticateResponse();
    return _client.invoke(ctx, 'Auth', 'Authenticate', request, emptyResponse);
  }
  Future<AuthUserAddResponse> userAdd(ClientContext ctx, AuthUserAddRequest request) {
    var emptyResponse = new AuthUserAddResponse();
    return _client.invoke(ctx, 'Auth', 'UserAdd', request, emptyResponse);
  }
  Future<AuthUserGetResponse> userGet(ClientContext ctx, AuthUserGetRequest request) {
    var emptyResponse = new AuthUserGetResponse();
    return _client.invoke(ctx, 'Auth', 'UserGet', request, emptyResponse);
  }
  Future<AuthUserListResponse> userList(ClientContext ctx, AuthUserListRequest request) {
    var emptyResponse = new AuthUserListResponse();
    return _client.invoke(ctx, 'Auth', 'UserList', request, emptyResponse);
  }
  Future<AuthUserDeleteResponse> userDelete(ClientContext ctx, AuthUserDeleteRequest request) {
    var emptyResponse = new AuthUserDeleteResponse();
    return _client.invoke(ctx, 'Auth', 'UserDelete', request, emptyResponse);
  }
  Future<AuthUserChangePasswordResponse> userChangePassword(ClientContext ctx, AuthUserChangePasswordRequest request) {
    var emptyResponse = new AuthUserChangePasswordResponse();
    return _client.invoke(ctx, 'Auth', 'UserChangePassword', request, emptyResponse);
  }
  Future<AuthUserGrantRoleResponse> userGrantRole(ClientContext ctx, AuthUserGrantRoleRequest request) {
    var emptyResponse = new AuthUserGrantRoleResponse();
    return _client.invoke(ctx, 'Auth', 'UserGrantRole', request, emptyResponse);
  }
  Future<AuthUserRevokeRoleResponse> userRevokeRole(ClientContext ctx, AuthUserRevokeRoleRequest request) {
    var emptyResponse = new AuthUserRevokeRoleResponse();
    return _client.invoke(ctx, 'Auth', 'UserRevokeRole', request, emptyResponse);
  }
  Future<AuthRoleAddResponse> roleAdd(ClientContext ctx, AuthRoleAddRequest request) {
    var emptyResponse = new AuthRoleAddResponse();
    return _client.invoke(ctx, 'Auth', 'RoleAdd', request, emptyResponse);
  }
  Future<AuthRoleGetResponse> roleGet(ClientContext ctx, AuthRoleGetRequest request) {
    var emptyResponse = new AuthRoleGetResponse();
    return _client.invoke(ctx, 'Auth', 'RoleGet', request, emptyResponse);
  }
  Future<AuthRoleListResponse> roleList(ClientContext ctx, AuthRoleListRequest request) {
    var emptyResponse = new AuthRoleListResponse();
    return _client.invoke(ctx, 'Auth', 'RoleList', request, emptyResponse);
  }
  Future<AuthRoleDeleteResponse> roleDelete(ClientContext ctx, AuthRoleDeleteRequest request) {
    var emptyResponse = new AuthRoleDeleteResponse();
    return _client.invoke(ctx, 'Auth', 'RoleDelete', request, emptyResponse);
  }
  Future<AuthRoleGrantPermissionResponse> roleGrantPermission(ClientContext ctx, AuthRoleGrantPermissionRequest request) {
    var emptyResponse = new AuthRoleGrantPermissionResponse();
    return _client.invoke(ctx, 'Auth', 'RoleGrantPermission', request, emptyResponse);
  }
  Future<AuthRoleRevokePermissionResponse> roleRevokePermission(ClientContext ctx, AuthRoleRevokePermissionRequest request) {
    var emptyResponse = new AuthRoleRevokePermissionResponse();
    return _client.invoke(ctx, 'Auth', 'RoleRevokePermission', request, emptyResponse);
  }
}
